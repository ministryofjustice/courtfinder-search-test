...
public class CourtFinderAddressSearchResultPage extends SeleniumPage {
	...
	private By searchByNameOrAddressBreadcrumbLink = new By.ByXPath(
	...
	public void clickSearchByNameOrAddressBreadcrumbLink() throws Exception {
		click(searchByNameOrAddressBreadcrumbLink);
	}
